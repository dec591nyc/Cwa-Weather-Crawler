...
export const App: React.FC = () => {
  ...
  const handleEarthquakeSelect = (earthquakeKey: string) => { setSelectedEarthquakeKey(earthquakeKey); setActiveDataLayer("earthquakes"); };
