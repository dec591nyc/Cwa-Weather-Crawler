...
export const App: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      if (earthquakesRes.ok) { const earthquakeData: EarthquakeResponse = await earthquakesRes.json(); setEarthquakes(earthquakeData.earthquakes || []); setEarthquakeTotalCount(earthquakeData.count || earthquakeData.earthquakes?.length || 0); }
