...
from crawler.normalize import normalize_cwa_observations, normalize_f_d0047_091, normalize_moenv_pm25, now_iso
...
def run_weather_observation_crawler() -> int:
    fetched_at = now_iso()
