...
export const metricOrder: ObservationMetric[] = ["temperature", "rainfall_10min", "rainfall_today", "humidity", "wind_speed", "visibility_km", "pm25", "pm10", "o3_8hr", "co_8hr", "so2", "no2"];

const metricScales: Record<ObservationMetric, LegendItem[]> = {
  temperature: [
    { stop: Number.NEGATIVE_INFINITY, label: "< 10°C", color: "#2563eb", desc: "寒冷" }, { stop: 10, label: "10-15°C", color: "#0284c7", desc: "偏涼" }, { stop: 15, label: "15-20°C", color: "#16a34a", desc: "舒適" }, { stop: 20, label: "20-25°C", color: "#ca8a04", desc: "溫和" }, { stop: 25, label: "25-30°C", color: "#f97316", desc: "偏暖" }, { stop: 30, label: "30-35°C", color: "#dc2626", desc: "炎熱" }, { stop: 35, label: ">= 35°C", color: "#7f1d1d", desc: "高溫" },
  ],
  rainfall_10min: [
    { stop: Number.NEGATIVE_INFINITY, label: "0 mm", color: "#94a3b8", desc: "無雨" }, { stop: 0.5, label: "0.5-2 mm", color: "#38bdf8", desc: "小雨" }, { stop: 2, label: "2-5 mm", color: "#0ea5e9", desc: "明顯" }, { stop: 5, label: "5-10 mm", color: "#2563eb", desc: "偏強" }, { stop: 10, label: "10-20 mm", color: "#7c3aed", desc: "強降雨" }, { stop: 20, label: ">= 20 mm", color: "#be123c", desc: "劇烈" },
  ],
  rainfall_today: [
    { stop: Number.NEGATIVE_INFINITY, label: "0 mm", color: "#94a3b8", desc: "無雨" }, { stop: 1, label: "1-40 mm", color: "#38bdf8", desc: "小量" }, { stop: 40, label: "40-80 mm", color: "#0ea5e9", desc: "明顯" }, { stop: 80, label: "80-200 mm", color: "#2563eb", desc: "大雨" }, { stop: 200, label: "200-350 mm", color: "#7c3aed", desc: "豪雨" }, { stop: 350, label: ">= 350 mm", color: "#be123c", desc: "劇烈" },
  ],
  humidity: [
    { stop: Number.NEGATIVE_INFINITY, label: "< 50%", color: "#f59e0b", desc: "乾燥" }, { stop: 50, label: "50-65%", color: "#84cc16", desc: "舒適" }, { stop: 65, label: "65-80%", color: "#14b8a6", desc: "濕潤" }, { stop: 80, label: "80-90%", color: "#0ea5e9", desc: "偏濕" }, { stop: 90, label: ">= 90%", color: "#1d4ed8", desc: "潮濕" },
  ],
  wind_speed: [
    { stop: Number.NEGATIVE_INFINITY, label: "< 2 m/s", color: "#94a3b8", desc: "微風" }, { stop: 2, label: "2-5 m/s", color: "#22c55e", desc: "和風" }, { stop: 5, label: "5-10 m/s", color: "#facc15", desc: "明顯" }, { stop: 10, label: "10-17 m/s", color: "#f97316", desc: "強風" }, { stop: 17, label: ">= 17 m/s", color: "#dc2626", desc: "劇烈" },
  ],
  visibility_km: [
    { stop: Number.NEGATIVE_INFINITY, label: "< 1 km", color: "#7f1d1d", desc: "極差" }, { stop: 1, label: "1-3 km", color: "#dc2626", desc: "不佳" }, { stop: 3, label: "3-6 km", color: "#f97316", desc: "偏低" }, { stop: 6, label: "6-10 km", color: "#ca8a04", desc: "普通" }, { stop: 10, label: ">= 10 km", color: "#16a34a", desc: "良好" },
  ],
  pm25: [
    { stop: Number.NEGATIVE_INFINITY, label: "0-15", color: "#16a34a", desc: "良好" }, { stop: 15.5, label: "15.5-35.4", color: "#ca8a04", desc: "普通" }, { stop: 35.5, label: "35.5-54.4", color: "#f97316", desc: "偏高" }, { stop: 54.5, label: ">= 54.5", color: "#dc2626", desc: "不良" },
  ],
  pm10: [
    { stop: Number.NEGATIVE_INFINITY, label: "0-50", color: "#16a34a", desc: "良好" }, { stop: 51, label: "51-100", color: "#ca8a04", desc: "普通" }, { stop: 101, label: "101-254", color: "#f97316", desc: "偏高" }, { stop: 255, label: ">= 255", color: "#dc2626", desc: "不良" },
  ],
  o3_8hr: [
    { stop: Number.NEGATIVE_INFINITY, label: "0-54", color: "#16a34a", desc: "良好" }, { stop: 55, label: "55-70", color: "#ca8a04", desc: "普通" }, { stop: 71, label: "71-85", color: "#f97316", desc: "偏高" }, { stop: 86, label: ">= 86", color: "#dc2626", desc: "不良" },
  ],
  co_8hr: [
    { stop: Number.NEGATIVE_INFINITY, label: "0-4.4", color: "#16a34a", desc: "良好" }, { stop: 4.5, label: "4.5-9.4", color: "#ca8a04", desc: "普通" }, { stop: 9.5, label: "9.5-12.4", color: "#f97316", desc: "偏高" }, { stop: 12.5, label: ">= 12.5", color: "#dc2626", desc: "不良" },
  ],
  so2: [
    { stop: Number.NEGATIVE_INFINITY, label: "0-20", color: "#16a34a", desc: "良好" }, { stop: 21, label: "21-75", color: "#ca8a04", desc: "普通" }, { stop: 76, label: "76-185", color: "#f97316", desc: "偏高" }, { stop: 186, label: ">= 186", color: "#dc2626", desc: "不良" },
  ],
  no2: [
    { stop: Number.NEGATIVE_INFINITY, label: "0-30", color: "#16a34a", desc: "良好" }, { stop: 31, label: "31-100", color: "#ca8a04", desc: "普通" }, { stop: 101, label: "101-360", color: "#f97316", desc: "偏高" }, { stop: 361, label: ">= 361", color: "#dc2626", desc: "不良" },
  ],
};
